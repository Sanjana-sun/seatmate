    ...
    <main className="mx-auto w-full max-w-4xl px-5 py-10">
      ...
      <div className="space-y-3">
        {data.rows.map((r) => {
          ...
          return (
            <div key={r.showtimeId} className="rounded-2xl border border-border bg-panel p-4">
              ...
              <div className="mt-4">
                <div className="flex h-3 overflow-hidden rounded-full bg-black/5">
                  <div className="bg-foreground/30" style={{ width: `${(r.sold / r.totalSeats) * 100}%` }} title="Sold normally" />
                ...
                <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-xs text-muted">
                  ...
                  <span className="flex items-center gap-1.5">
                    <i className="h-2.5 w-2.5 rounded-[2px] bg-foreground/30" /> {r.sold} sold
                  </span>
                  <span className="flex items-center gap-1.5">
        ...
        <>
          ...
          <div className="space-y-2">
            {data.rallies.map((r, i) => (
              <div key={i} className="flex items-center justify-between rounded-xl border border-border bg-panel p-3 text-sm">
                <span>
